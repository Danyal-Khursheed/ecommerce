  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row text-center text-md-left mt-3 pb-3">
      ...
      <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <p>Hey this is our DBMS project and we are from University of Engineering and Technology Peshawar</p>
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <p>
          <i class="fas fa-home mr-3"></i> Uet Peshawar</p>
        <p>
          <i class="fas fa-envelope mr-3"></i> danyalkhursheed9@gmail.com</p>
        <p>
          <i class="fas fa-phone mr-3"></i>Danyal 03498030357</p>
        <p>
          <i class="fas fa-phone mr-3"></i>Maaz  03123456789</p>
          <p>
          <i class="fas fa-phone mr-3"></i>Hamid 03123456789</p>
      </div>
      <!-- Grid column -->
